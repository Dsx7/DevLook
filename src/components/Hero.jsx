...
// Using live URLs from their site
const backgroundImages = [
  "/Emirates-airpline-in-flight.webp",
  "/bg_2.webp",
  "/bg_3.webp",
  ...
  return (
    <section className="w-full py-0">
      <div className="w-full px-0">
        <div className="w-full h-svh relative p-2">
          ...
          <div className="items-end justify-between absolute bottom-0 left-0 z-30 w-full p-7 flex">
            <div className="hidden flex-shrink-0 md:inline">
              <div className="w-full text-center md:text-left">
                <p className="text-sm font-sans-primary leading-normal text-pretty mb-5 lg:text-base text-white drop-shadow-md">
          ...
          <div className="w-full h-full relative overflow-hidden rounded-3xl">
            <div className="w-full h-full overflow-hidden grid bg-grey-900 rounded-3xl scale-105">
              ...
              {/* 3. Reduced Blur: Changed from blur-3xl to blur-md to match live site */}
              <div className="col-start-1 row-start-1 relative z-0 overflow-hidden blur-sm lg:blur-md bg-grey-900 scale-110">
                <img 
              ...
              <div className="col-start-1 row-start-1 z-20 relative flex justify-center items-center">
                <div className="flex flex-col items-center" ref={headingRef}>
                  ...
                  <div className="flex flex-col items-center justify-center mb-6">
                    <div className="uppercase text-[0.65rem] font-medium leading-tight tracking-widest text-center mb-3 text-white">
                      #1 MOST RECOMMENDED<br/>CONTENT MARKETING AGENCY
                    </div>
                    
                    {/* Award Logos */}
                    <div className="flex items-center gap-x-2 text-white/90">
                       ...
                       <div className="w-12 aspect-20/9 relative">
                         <img src="/hero/global-search-awards.webp" alt="Global Search Awards" className="w-full h-full object-contain" />
                       </div>
                       <div className="w-12 aspect-20/9 relative">
                         <img src="/hero/Mask-group.webp" alt="The Drum" className="w-full h-full object-contain" />
                       </div>
                       <div className="w-12 aspect-20/9 relative">
                         <img src="/hero/UKSocial-Media-Awards-White.webp" alt="UK Social Media Awards" className="w-full h-full object-contain" />
                       </div>
                       <div className="w-12 aspect-20/9 relative hidden lg:inline-flex">
                         <img src="/hero/UK-Content-Awards-White.webp" alt="UK Content Awards" className="w-full h-full object-contain" />
                       </div>
                  ...
                  <h1 className="inline-flex flex-wrap text-balance relative flex-col text-center justify-center text-white text-6xl/[0.9] md:text-6xl/none lg:text-7xl/[0.9] xl:text-[5.5rem]/[0.9] 2xl:text-[8.5rem]/[0.9] font-sans-primary font-medium tracking-tight">
                    ...
                    <div className="flex flex-wrap items-center relative text-center justify-center mt-[-2%]">
                      <div className="inline mr-2 md:mr-3">Category</div>
                      
                      {/* 5. Rounded Square Inline Image */}
                      <div 
                        className="inline-block relative overflow-hidden bg-black/20 mx-1 md:mx-3 shadow-2xl rounded-xl" 
                        style={{ width: "0.8em", height: "0.8em", transform: "translateY(-0.06em)" }}
                      >
                        <img 
                          src={backgroundImages[currentImageIndex]} 
                          alt="Inline Match" 
                      ...
                      <div className="inline ml-1 md:ml-0">Leaders</div>
                    </div>
                  </h1>
                  
                  {/* Fixed Subtext Sizing */}
                  <div className="inline-flex flex-wrap text-balance relative text-left justify-start text-white text-lg/tight md:text-xl/tight xl:text-3xl/none font-sans-primary font-medium tracking-tight mt-4 lg:mt-6 drop-shadow-md">
