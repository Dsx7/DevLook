  ...
  return (
    <section className="w-full pt-12 xl:pt-24 pb-12 xl:pb-24 overflow-hidden bg-grey-100">
      <div className="w-full px-4 md:px-7">
        ...
        ========================================= */}
        <div className="w-full grid grid-cols-1 md:flex md:flex-row justify-between items-start gap-x-5 gap-y-6 md:gap-y-8">

          {/* Left Column (Paragraph)
              Mobile: Order 2 (Middle) 
              Desktop: Order 1 (Left Side) */}
          <div className="order-2 md:order-1 w-full md:mt-2 max-w-sm xl:max-w-xl 3xl:max-w-2xl 4xl:max-w-3xl">
          ...
          {/* Right Container Wrapper 
              Mobile: "display: contents" lets items behave as direct children of the grid above for seamless re-ordering
              Desktop: Acts as a standard flex-column wrapper */}
          <div className="contents md:flex md:flex-col md:w-full md:max-w-[40rem] xl:max-w-[42rem] 3xl:max-w-[52rem] md:gap-y-7 order-1 md:order-2">

            {/* Heading 
                Mobile: Order 1 (Top) */}
            <h2 className="order-1 md:order-none w-full max-w-[24rem] md:max-w-none flex flex-col text-left justify-start text-grey-900 text-5xl/none lg:text-6xl/none xl:text-7xl/[0.9] 3xl:text-[5.5rem]/[0.9] font-sans-primary font-medium tracking-tight">
              {/* First Line */}
            ...
            {/* Action Buttons 
                Mobile: Order 3 (Bottom), Stacked and Full-Width */}
            <div className="order-3 md:order-none w-full flex flex-col md:flex-row flex-wrap gap-4 mt-2">
              <Link
                href="#"
                className="w-full md:w-auto group flex justify-center gap-x-2 items-center relative leading-tight tracking-tightish capitalize font-sans-primary font-medium overflow-hidden cursor-pointer text-base px-6 py-3 rounded-3xl transition-all duration-300 hover:rounded-xl bg-white text-grey-900 shadow-sm"
              >
              ...
              <Link
                href="#"
                className="w-full md:w-auto group flex justify-center gap-x-2 items-center relative leading-tight tracking-tightish capitalize font-sans-primary font-medium overflow-hidden cursor-pointer text-base px-6 py-3 rounded-3xl transition-all duration-300 hover:bg-black/5 text-grey-900"
              >
                <div className="relative overflow-hidden flex items-center h-[20px]">
